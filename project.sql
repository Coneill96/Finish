...
(56, 'Maths', '2018-05-08', 'Extension of Deadline', '2018-05-19'),
(57, 'Maths', '2018-05-08', 'Extension of Deadline', '2018-05-19'),
(58, 'Maths', '2018-05-08', 'Extension of Deadline', '2018-05-19'),
(59, 'Maths', '2018-05-08', 'Extension of Deadline', '2018-05-19'),
(60, 'Maths ', '2018-05-08', 'Extension of Deadline', '2018-05-19'),
(61, 'Maths ', '2018-05-17', 'Extension of Deadline', '2018-05-18'),
(62, 'Maths ', '2018-05-17', 'Extension of Deadline', '2018-05-18'),
(63, 'Software Development', '2018-05-16', 'Extension of Deadline', '2018-05-18'),
(64, 'Software Development', '2018-05-16', 'Extension of Deadline', '2018-05-18'),
(65, 'Software Development', '2018-05-16', 'Extension of Deadline', '2018-05-18'),
(66, 'Software Development', '2018-05-16', 'Extension of Deadline', '2018-05-18'),
(67, 'Software Development', '2018-05-16', 'Extension of Deadline', '2018-05-18'),
(68, 'Software management', '2018-05-10', 'Extension of Deadline', '2018-05-10'),
(69, 'computer technologies', '2018-05-23', 'Extension of Deadline', '2018-05-16'),
(70, 'Maths', '2018-05-17', 'Extension of Deadline', '2018-05-25'),
(71, 'Maths', '2018-05-09', 'Extension of Deadline', '2018-05-17');
...
(46, 'Broken wrist', '2018-05-24', '2018-05-24', 'C:\\fakepath\\MEDICAL INFORMATION FORM.pdf', 'i broke my wrist and am unable to write'),
(47, 'Broken wrist', '2018-05-24', '2018-05-24', 'C:\\fakepath\\MEDICAL INFORMATION FORM.pdf', 'i broke my wrist and am unable to write'),
(58, 'Car broke down', '2018-05-03', '2018-05-10', 'C:\\fakepath\\2.pdf', 'car broke down'),
(59, 'Broken wrist', '2018-05-23', '2018-05-10', 'C:\\fakepath\\4.pdf', 'jkhjkhih'),
(60, 'I broke my wrist', '2018-05-09', '2018-05-23', 'C:\\fakepath\\1.pdf', 'I broke my wrist'),
(61, 'Broken wrist', '2018-05-23', '2018-05-16', 'uploads/1.pdf', 'shfjkdsn');
...
(20, '2018-04-19 17:19:38', 'Accepted', 25, 46, 43),
(21, '2018-04-23 12:07:23', 'Accepted', 14, 54, 44),
(22, '2018-04-23 19:24:09', 'Pending', 14, 55, 45),
(35, '2018-05-28 20:14:14', 'Pending', 30, 68, 58),
(36, '2018-05-28 20:49:15', 'Pending', 30, 69, 59),
(37, '2018-05-28 20:51:55', 'Pending', 30, 70, 60),
(38, '2018-05-30 12:06:11', 'Pending', 26, 71, 61);
...
(14, 'B00659788', '$2y$10$M5aYKiqlNJNmhNlU7DbXxOfxELyAZkWQZ9qataw4lScSr62XdKssS', 'ONeill-C98@ulster.ac.uk', '2018-03-28 20:31:24', 'Christopher', 'O\'Neill', 'admin'),
...
(26, 'B00659783', '$2y$10$tDJ5oCYFjjDdtnPZ6Rn66.Z0To6LNw1NyM2Ubs5Q6K.9.Nlgu19u2', 'vfegan@ulster.ac.uk', '2018-04-24 14:23:50', 'Vicky', 'Fegan', 'user'),
(28, 'a12345678', 'adminEC1', 'admin@ulster.ac.uk', '2018-04-26 10:54:43', 'admin', 'admin', 'admin'),
(29, 'B00659743', '$2y$10$ViCB3kNAGl6ZPQd9WxAL/udAG4zHPySMlSX92K4qo.damJN8zOgga', 'levinaoneill2009@hotmail.co.uk', '2018-05-28 18:43:57', 'Levina', 'O&#39;Neill', 'user'),
(30, 'B00659766', '$2y$10$D2eSsH3mvCSBtj9QBXnNuOpwSmxUIOS2wzrtQ8FPBCaGyH..nFrgG', 'declan778@btinternet.com', '2018-05-28 19:12:45', 'DECLAN', 'O&#39;NEILL', 'user'),
(31, 'B00654322', '$2y$10$1QabzXyNxGbKrb.22Jgy.eBnv5mmyXLrkjcoLij/PbLrn82f/EAAq', 'rorymagee@ulster.ac.uk', '2018-05-29 21:20:48', 'Rory', 'Magee', 'user');
...
--
ALTER TABLE `assessment`
  MODIFY `ass_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `reason_for_request`
--
ALTER TABLE `reason_for_request`
  MODIFY `rfr_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'reason for request', AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `requests`
--
ALTER TABLE `requests`
  MODIFY `request_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'request reference', AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `user_id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'User Id', AUTO_INCREMENT=32;
